...
# Get most important bigram characters
...
# Obtain moset important bigram characters from each language
features = {}
features_set = set()
...
for l in languages:
    ...
    #get 200 most important bigram characters
...
# Calculate the common bigram chars and fill in the matrix
...
# The common_feature_matrix now contains the counts of common bigram chars between each pair of lists
